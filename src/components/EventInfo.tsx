    ...
    <section id="event-info" className="event-info section">
      <div className="container">
        ...
        <div className="event-grid">
          <div className="event-card card">
            <div className="event-card-content">
              ...
              <h3 className="event-card-title">Cuándo</h3>
              <p className="event-card-text">Sábado 21 de Marzo</p>
          ...
          <div className="event-card card">
            <div className="event-card-content">
              ...
              <h3 className="event-card-title">Dónde</h3>
              ...
              <p className="event-card-subtext">Concepción, Tucumán</p>
              <p className="event-card-subtext">
                <a 
          ...
          <div className="event-card card">
            <div className="event-card-content">
              ...
              <p className="event-card-text">Saltos, Música & Diversión</p>
        ...
        <div className="event-footer">
          <p>¡Deslizá para reservar tu asistencia! 🎊</p>
        </div>
      </div>
    </section>
  );
